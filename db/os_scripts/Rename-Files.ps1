...
Краткое использование:
  .\Rename-Files.ps1 -FromIndex 49 -IndexTarget 70

Что делает пример:
  Берет все файлы, начиная с индекса 49, и сдвигает их так,
  чтобы файл с индексом 49 стал индексом 70.

Параметры:
  -FromIndex    С какого индекса начинать переименование.
  -ToIndex      До какого индекса переименовывать. По умолчанию до последнего файла.
  -IndexTarget  В какой индекс должен превратиться FromIndex.
  -Shift        Явный сдвиг. Обычно не нужен, если задан IndexTarget.
  -Digits       Длина числового префикса. По умолчанию 3.
  -Path         Папка с SQL-файлами. По умолчанию ..\sql
#>
