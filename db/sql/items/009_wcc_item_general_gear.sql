...
WITH raw_data (
  ...
  ('T126','general_gear.group.transport','Транспорт','Transport','Обычная инвалидная коляска','Basic Wheelchair','Нивелирует штрафы Скор, Уклонения/Изворотливости и Атлетики от инвалидности. Плавание/лазанье: -3. Атаки по коляске попадают во владельца.','Negates SPD, Dodge/Escape, and Athletics penalties from disability. Swimming/climbing checks: -3. Attacks against the wheelchair hit its user.','dlc_wpaw','',6,50,'availability.E'),
  ('T127','general_gear.group.transport','Транспорт','Transport','Качественная инвалидная коляска','Quality Wheelchair','Нивелирует штрафы Скор, Уклонения/Изворотливости и Атлетики от инвалидности. Плавание/лазанье: -1. Атаки по коляске попадают во владельца.','Negates SPD, Dodge/Escape, and Athletics penalties from disability. Swimming/climbing checks: -1. Attacks against the wheelchair hit its user.','dlc_wpaw','',3,200,'availability.P'),

  ('T128','general_gear.group.transport','Транспорт','Transport','Обычный протез','Basic Prosthesis','Полная функциональность; штраф Скор игнорируется. Броски атаки/защиты этой рукой -3; нога: Уклонение/Изворотливость -1. Не проводник Хаоса. Атаки по протезу попадают во владельца.','Full functionality; SPD penalty is ignored. Attacks/defenses with this arm are made at -3; with a prosthetic leg, Dodge/Escape checks are made at -1. Not a Chaos conduit. Attacks against the prosthesis hit the wearer.','dlc_wpaw','',2,50,'availability.E'),
  ('T129','general_gear.group.transport','Транспорт','Transport','Магический протез','Magical Prosthesis','Полная функциональность; штраф Скор игнорируется. Не проводник Хаоса. Атаки по протезу попадают во владельца.','Full functionality; SPD penalty is ignored. Not a Chaos conduit. Attacks against the prosthesis hit the wearer.','dlc_wpaw','',1,500,'availability.R'),
  ('T130','general_gear.group.transport','Транспорт','Transport','Ведьмачий протез','Witcher Prosthesis','Полная функциональность; штраф Скор игнорируется. Проводник для Хаоса; Бонус 1d6 урона серебром к удару протезом. Атаки по протезу попадают во владельца.','Full functionality; SPD penalty is ignored. Chaos conduit; +1d6 silver damage to attacks made with the prosthesis. Attacks against the prosthesis hit the wearer.','dlc_wpaw','',2,800,'availability.R'),
  ('T131','general_gear.group.transport','Транспорт','Transport','Протез-проводник','Conduit Prosthesis','Полная функциональность; штраф Скор игнорируется. Проводник для Хаоса; "Фокусирующее (2)" и "Улучшенное фокусирующее". Атаки по протезу попадают во владельца.','Full functionality; SPD penalty is ignored. Chaos conduit; Focus (2) and Greater Focus. Attacks against the prosthesis hit the wearer.','dlc_wpaw','',3,1000,'availability.R')
),
ins_i18n AS (
