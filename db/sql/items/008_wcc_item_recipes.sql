...
BEGIN
  RETURN CASE
    ...
    WHEN ing_name = 'Собачье сало' THEN 'ingredients.dog_tallow'
    ELSE NULL
  END;
END;
...
WITH raw_data (
  ...
  ('R027','core','reciples.group.oil','availability.U',
    ...
    '30','time.unit.minute',
    NULL,
    'Аер, Солнце, Купорос, Квебрит, Собачье сало',
