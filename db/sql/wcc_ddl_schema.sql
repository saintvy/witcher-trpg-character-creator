...
DROP MATERIALIZED VIEW IF EXISTS wcc_item_potions_v CASCADE;
DROP MATERIALIZED VIEW IF EXISTS wcc_item_blueprints_v CASCADE;
DROP MATERIALIZED VIEW IF EXISTS wcc_item_mutagens_v CASCADE;
DROP MATERIALIZED VIEW IF EXISTS wcc_item_trophies_v CASCADE;
DROP MATERIALIZED VIEW IF EXISTS wcc_magic_rituals_v CASCADE;
DROP MATERIALIZED VIEW IF EXISTS wcc_magic_invocations_v CASCADE;
DROP MATERIALIZED VIEW IF EXISTS wcc_magic_hexes_v CASCADE;
DROP MATERIALIZED VIEW IF EXISTS wcc_magic_spells_v CASCADE;
...
DROP TABLE IF EXISTS wcc_item_potions CASCADE;
DROP TABLE IF EXISTS wcc_item_blueprints CASCADE;
...
DROP TABLE IF EXISTS wcc_magic_spells CASCADE;
DROP TABLE IF EXISTS wcc_magic_hexes CASCADE;
DROP TABLE IF EXISTS wcc_magic_invocations CASCADE;
DROP TABLE IF EXISTS wcc_magic_rituals CASCADE;
DROP TABLE IF EXISTS wcc_shop_item_dlc_extra CASCADE;
