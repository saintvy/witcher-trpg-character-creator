\echo '044_life_events_ally_how_met.sql'
...
, vals AS (
           SELECT ('<td>' || to_char(probability*100, 'FM990.00') || '%</td>' ||
                  ...
                  lang
           FROM (VALUES
                  ('ru', 1, 'Вы его спасли', 0.1::numeric),
                  ('ru', 2, 'Встретились в таверне', 0.1),
                  ('ru', 3, 'Он вас спас', 0.1),
                  ('ru', 4, 'Он вас нанял', 0.1),
                  ('ru', 5, 'Вы вместе попали в ловушку', 0.1),
                  ('ru', 6, 'Вам пришлось работать вместе', 0.1),
                  ('ru', 7, 'Вы его наняли', 0.1),
                  ('ru', 8, 'Спелись по пьяни', 0.1),
                  ('ru', 9, 'Встретились в дороге', 0.1),
                  ('ru', 10, 'Сражались вместе', 0.1),
