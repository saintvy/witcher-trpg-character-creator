...
-- Связи
-- Переход из профессии (через правило is_witcher) - добавлен в 090_profession.sql
INSERT INTO transitions (from_qu_qu_id, to_qu_qu_id, ru_ru_id, priority)
  SELECT 'wcc_profession', 'wcc_past_witcher_q1', r.ru_id, 1
    FROM (SELECT ru_id FROM rules WHERE name = 'is_witcher') r;