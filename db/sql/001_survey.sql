...
SELECT ck_id('witcher_cc.hierarchy.' || v.path) AS id
  ...
  FROM (VALUES
          ...
          ('life_events_misfortune_details_monstrosity', 'ru', 'Чудовищность'),
          ('life_events_misfortune_details_monstrosity', 'en', 'Monstrosity'),
          ...
          ('witcher_events_danger_events_details_monstrosity', 'ru', 'Чудовищность'),
          ('witcher_events_danger_events_details_monstrosity', 'en', 'Monstrosity'),
