...
export default function SettingsPage() {
  ...
  const content = {
    en: {
      ...
      description: "Minimal settings panel for the current portal version.",
      languageCard: {
        title: "Language",
    ...
    ru: {
      ...
      description: "Минимальная панель настроек для текущей версии портала.",
      languageCard: {
        title: "Язык",
          ...
          <div className="card">
            ...
            <div className="field">
              <label className="field-label">
                ...
                <span>{displayLang === "ru" ? "interface" : "interface"}</span>
              </label>
